...
__weak bool s32_serdes_is_external_clk_in_hwconfig(int id)
{
	size_t subarg_len = 0;
...
__weak unsigned long s32_serdes_get_clock_fmhz_from_hwconfig(int id)
{
	size_t subarg_len = 0;
...
__weak enum pcie_phy_mode s32_serdes_get_phy_mode_from_hwconfig(int id)
{
...
__weak enum serdes_mode s32_serdes_get_op_mode_from_hwconfig(int id)
{
