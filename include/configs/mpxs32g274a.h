...
#ifndef __MPXS32G274A_H
#define __MPXS32G274A_H
...
#define CONFIG_S32GEN1_HWCONFIG "pcie0:mode=rc&sgmii,clock=ext,fmhz=100,xpcs_mode=0;pcie1:mode=rc&sgmii,clock=ext,fmhz=100,xpcs_mode=both"
#else
...
#define PFENG_EMAC "1"
#elif CONFIG_IS_ENABLED(MICROSYS_CRXS32G)
