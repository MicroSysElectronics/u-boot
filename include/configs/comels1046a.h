...
#ifndef __COMELS1046A_H__
#define __COMELS1046A_H__
...
#define CONFIG_SYS_I2C_EEPROM_NXID_MAC        3
...
#define MTDPARTS_DEFAULT "mtdparts=nflash:64m@0(kernel),-@64m(rootfs)"

#undef CONFIG_ENV_OFFSET
#undef CONFIG_ENV_SIZE

#define CONFIG_ENV_OFFSET         0x200       /* 512B */
#define CONFIG_ENV_SIZE           0x1e00      /* 7.5KB */

#include <asm/fsl_secure_boot.h>
#endif /* __COMELS1046A_H__ */
